...
# │  BOT TOKEN  add karo.   ││
# └──────────────────────────────────────────────────────────────┘
BOT_TOKEN_HARDCODED = "8812950233:AAFM7BeEq0k8mYMw2R_fLjnwvGNb6tSazgU"   # ← ADD BOT TOKEN
TOKEN = (
...
try:
    OWNER_ID = int(os.environ.get("OWNER_ID", "8291716115"))
...
BRAND       = "SALMAN HOSTING ΒOT"
BRAND_VER   = "v2.1"
BRAND_TAG   = f"{BRAND} {BRAND_VER}"
SUPPORT_USR = "@infohub_salman313"
UPDATE_CH   = "https://t.me/infohub_salman"
...
PAYMENT_METHODS = {
    "bkash": {"name": "bKash", "number": "+917050580017",        "type": "Send Money", "tag": "[B]"},
    "nagad": {"name": "Nagad", "number": "+919708061251",     "type": "Send Money", "tag": "[N]"},
}
...
_PHOTO_SPECS: Dict[str, Tuple[str, str, str]] = {
    ...
    "main": ("ꜱᴀʟᴍᴀɴ ʜᴏꜱᴛɪɴɢ",  "#1E1B4B", "ᴍᴀɪɴ ᴍᴇɴᴜ"),
"welcome": ("ᴡᴇʟᴄᴏᴍᴇ",        "#0F172A", "ꜱᴀʟᴍᴀɴ ʜᴏꜱᴛɪɴɢ"),
...
REQUIRED_GROUPS = [
    {"id": -1003910861119, "link": "https://t.me/+ig54uNF2uRczYzdl", "name": "Group 1"},
]
